...
public class ParEImpar {
	public static void main(String[] args) {
		Scanner entrada = new Scanner(System.in); // Abertura da entrada de fluxo de dados através do teclado

		System.out.println("Quantidade de números: "); // Peça um número
		int quantidadeDeNumeros = entrada.nextInt(); // Entrada de dados, neste caso de um int.
		...
		do { // primeiro, independente do que tem no while, faça:
			...
			int numero = entrada.nextInt(); // Entrada de dados, neste caso de um int.
